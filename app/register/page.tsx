                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-3 py-2.5 pr-9 bg-dark-900/50 border border-dark-700 rounded-lg text-dark-200 text-sm placeholder-dark-500 focus:outline-none focus:border-dark-500 transition-colors"
                      />
