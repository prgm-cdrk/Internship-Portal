            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full bg-dark-900/50 border border-dark-700 rounded-lg px-4 py-3 pr-10 text-dark-200 placeholder-dark-500 focus:outline-none focus:border-dark-500 transition"
                  required
                />
