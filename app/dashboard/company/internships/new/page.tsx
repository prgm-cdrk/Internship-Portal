    ...
    <div className="p-8 bg-gradient-to-b from-neutral-950 to-black min-h-full dashboard-grid">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white tracking-wide">Post New Internship</h1>
            <p className="text-neutral-500 text-sm mt-0.5">Fill out the details to create a new internship listing</p>
          </div>
        </div>
