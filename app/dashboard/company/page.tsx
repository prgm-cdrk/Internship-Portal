    ...
    <div className="p-8 bg-gradient-to-b from-neutral-950 to-black min-h-full animate-scan-line dashboard-grid relative">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8 flex items-center gap-5">
          {company.logoUrl ? (
            <div className="w-16 h-16 rounded-2xl overflow-hidden bg-neutral-900 border border-neutral-800 shrink-0">
              <img src={company.logoUrl} alt={company.name} className="w-full h-full object-cover" />
            </div>
          ) : (
            <div className="w-16 h-16 rounded-2xl bg-neutral-900 border border-neutral-800 flex items-center justify-center shrink-0">
